/*Question -: A positive integer d is said to be a factor of another positive integer N
...
The highest factor is 12 and the third largest factor is 4. The output must be 4.
...
There are only 8 factors. As k is more than the number of factors, the output is 1.*/
import java.util.*;
class Highest_Factor
{
    public static void main(String[] args)
    {
        Scanner sc=new Scanner(System.in);
        int num,r,i,c=0;
        System.out.print("Enter The Number You Want To Find The Factor: ");
        num=sc.nextInt();
        System.out.print("Enter The Position Of The Factor: ");
        r=sc.nextInt();
