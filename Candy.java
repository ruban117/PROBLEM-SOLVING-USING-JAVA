...
The only constraint is that he can choose any two boxes and store their joint contents in an empty box only.
...
then it takes him exactly X+Y seconds of time.
...
Adding 3 + 3 in a new box takes 6 seconds.Adding 4 + 6 in a new box takes 10 seconds.Hence total time taken is 19 seconds.
...
5 boxes, each containing 1, 2, 3, 4 and 5 candies respectively.Adding 1 + 2 in a new box takes 3 seconds.Adding 3 + 3 in a new box
takes 6 seconds.Adding 4 + 6 in a new box takes 10 seconds.Adding 5 + 10 in a new box takes 15 seconds.
Hence total time taken is 34 seconds. There could be other combinations also, but overall time does not go below 33 seconds.*/
...
public static void main(String  args[]) {
    ...
    for (l = 0; l < t; l++) {
        ...
        for (i = 1; i < k; i++)
            s1 += s[i];
            System.out.print("\nMinimum time in which all the candies can be collected: ");
